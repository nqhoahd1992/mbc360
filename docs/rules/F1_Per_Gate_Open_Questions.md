...
**Kịch bản hỏng nếu ta sai:** dự án cố ý chưa chốt dạng bào chế ở Gate 2 (*"sản phẩm bảo vệ da cho trẻ sơ sinh, cream hay balm để formulation quyết ở Gate 5"*) không thể qua Gate 2 dù brief đầy đủ — cùng hạng lỗi với bug `pbCautionLimits` ở Gate 7 đã ship: check chặn công việc đúng, chỉ lộ ra khi có người đụng vào.
