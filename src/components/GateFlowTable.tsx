...
import { getChangeTrigger } from '../config/changeTriggers';
import { useAppStore } from '../store/useAppStore';
import { currentGateIndex, gateBlockers, gateIndex, isAwaitingDecision, isGatePassed } from '../utils/gateProgress';
